...
?>
    ...
    <body>
        <header>
            ...
            <div class="recepcion">
                <div class="titulo">
                    <h4 class="titulos">Modificaciones a transportes</h4>
                </div>
                <div class="ayuda">
            ...
            <article class="tabla">
                <table class="table table-condensed table-bordered table-responsive display compact" id="dataTables" style>
                    ...
                    <tbody>
                        <?php
							$obj= new conectarDB();
	                        $data= $obj->subconsulta("CALL transportesModificaciones()");
                                ...
                                if ($dat=='null') {
                                    ...
                                    foreach ($data as $filas) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $filas['usuarioModificador'] ?></td>
                                            <td><?php echo $filas['rif_transp'] ?></td>
                                            <td><?php echo $filas['transEstado'] ?></td>
                                        </tr>
                                    <?php } ?>        
                        <?php } ?>
                            <!--Fin del if $dat-->
