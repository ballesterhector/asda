...
<html lang="es">
  ...
  <body>
    <header>
		...
		<div class="enlinea">
			<div class="titulo">
				<h3 class="titulos" id="">Inventario disponible por lote</h3>
			</div>
			<div>
      ...
      <article class="tabla">
      	<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
			...
			<tbody>
				<?php
					$obj= new conectarDB();
					$data= $obj->subconsulta("CALL inv_DisponiblePorLote('".$_GET['id_cliente']."')");
    ...
    <div>
		...
		<script src="aplicaciones/js/inventarioDisponibleLote.js"></script>
	</div>
  </body>
</html>