...
?>
    ...
    <body>
        <header>
            ...
            <div class="recepcion">
                <div class="titulo">
                    <h4 class="titulos">Modificaciones a clientes</h4>
                </div>
                <div class="ayuda">
        ...
        <script type="text/javascript">
            ...
            $('#ejecuta').on('click', function () {
                ...
                document.location = 'modificacionesClientes.php?clibus=' + numClie;
            });
            
            function modificaExcel() {
                var numClie = <?php echo $_GET['clibus'] ?>;
                document.location.href = ('modificaClientesExcel.php?clibus=' + numClie);
            }
