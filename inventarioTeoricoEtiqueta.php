...
<html lang="es">
  ...
  <body>
    <header>
		...
		<div class="enlinea">
			<div class="titulo">
				<h3 class="titulos" id="">Inventario teórico por etiqueta</h3>
			</div>
			<div>
			...
			<div class="nuevo">
			    ...
			    <a href="javascript: onclick(inventarioExcel())"><i class="fas fa-file-excel fa-2x fa-fw" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="archivo por etiqueta"></i></a>
            </div>
		</div>
    </header>
    <div id='main'>
      <article class="tabla">
      	<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
			...
			<tbody>
				<?php
					$obj= new conectarDB();
					$data= $obj->subconsulta("CALL invTeoricoPorEtiqueta('".$_GET['id_cliente']."')");
    ...
    <div>
		...
		<script src="aplicaciones/js/inventarioTeoricoEtiqueta.js"></script>
	</div>
  </body>
</html>