...
<html lang="es">
  ...
  <body>
    <header>
		...
		<div class="enlinea">
			<div class="titulo">
				<h3 class="titulos" id="">Inventario teórico por Codigo</h3>
			</div>
			<div>
      ...
      <article class="tabla">
      	<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
			...
			<tbody>
				<?php
					$obj= new conectarDB();
					$data= $obj->subconsulta("CALL invTeoricoPorCodigo('".$_GET['id_cliente']."')");
    ...
    <script src="aplicaciones/js/jquery-1.11.1.min.js"></script>
		...
		<script src="aplicaciones/js/inventarioTeoricoCodigo.js"></script>
	</div>
  </body>
</html>