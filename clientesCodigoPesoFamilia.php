...
?>
	...
	<body>
		<header>
			...
			<div class="recepcion">
				<div class="titulo">
					<h3 class="titulos">Pesos por código y familia</h3>
				</div>
			...
			<article class="tabla">
				<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
					...
					<tbody>
						<?php
							$obj= new conectarDB();
	                        $data= $obj->subconsulta("CALL clientesPesoCodigoFamilia('".$_GET['id_cliente']."')");
		...
		<script type="text/javascript">
            ...
            $('#cliBusca').on('change', function () {
			    ...
			    document.location = 'clientesCodigoPesoFamilia.php?id_cliente=' + numClie;
			});
        </script>
	</body>
