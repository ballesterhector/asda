<?php
	...
	require_once ("aplicaciones/dompdf/dompdf_config.inc.php");
...
<html>
	<head>
		...
		<link rel="stylesheet" href="aplicaciones/css/style.css">
	</head>
	<body>
    
        <table width="530" align="center" height="35" border="0">
			<tr>
				<td><img src="aplicaciones/imagenes/logo.png" width="85px"></td>
				<td align="center"><b width="300" align="left">INVENTARIO EVOLUCION <br>
                  '.$data[0]['nombre_cli'].'  
                </b>
                </td>
			</tr>
		...
		<thead>
			...
			$codigohtml.='
				<tr style="padding:0">
					...
					<td align="">'. $filas['movimientoEvol'].'</td>
                    <td align="">'. $filas['documentoEvol'].'</td>
					<td align="">'. $filas['fechaDocumentoEvol'].'</td>
                    <td align="">'. $filas['pickingEvol'].'</td>
                    <td align="">'. $filas['codigoEtiqueta'].'</td>
					<td align="">'. $filas['productoEtiqueta'].'</td>
                    <td align="">'. $filas['loteEtiqueta'].'</td>
                    <td align="">'. $filas['venceEtiqueta'].'</td>
            ...
            $codigohtml.='
                <tr>
                    <td colspan="11" align="right"><b>Totales</b></td>
