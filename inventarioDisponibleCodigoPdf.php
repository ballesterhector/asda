...
<html>
	<head>
		...
		<link rel="stylesheet" href="aplicaciones/css/estilosFlex.css">
	</head>
	<body>
        ...
        <table width="530" align="center" height="35" border="0">
			<tr>
				...
				<td align="center"><b width="300" align="left">INVENTARIO DISPONIBLE POR CÓDIGO <br>
                  '.$data[0]['nombre_cli'].'  
                </b>
                </td>
			</tr>
		...
		<table width="95%" border="1" style="border-collapse: collapse;margin-left:10px" class="">
		<thead>
			<tr class="bg-info">
