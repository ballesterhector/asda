    ...
    <body>
        <header>
            <div class="tablaPdf">
                ...
                <div class="acta">
                    <label for="" class="control-label">ACTA DE RECEPCION</label>
        ...
        <div class="data">
            <table border=1 style="border-collapse: collapse" class="tabla1" width="100%">
                ...
                <tbody>
                    <?php
                        $obj= new conectarDB();
                        $data= $obj->subconsulta("CALL etiquetasPDF('".$_GET['numRecep']."')");
                        $totalE=0;
                        $total=0;
                        $totalK=0;
                    ...
                    ?>
                        <tr>
                            ...
                            <td align='center'><?php echo $filas['paletasllenas'] ?></td>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($data as $filas) { 
                            ...
                            $totalkcest=$totalcest+$filas['kilos'];
                        ?>
                        <tr>
                            <td class="codigo"><?php echo $filas['codigoEtiqueta'] ?></td>
                            <td class="producto"><?php echo $filas['productoEtiqueta'] ?></td>
                            <td align='right' class="unidades"><?php echo number_format($filas['cestas'],0) ?></td>
