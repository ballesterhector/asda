...
?>
    ...
    <body>
        <header>
            ...
            <div class="enlinea">
                <div class="titulo">
                    <h3 class="titulos">Asignación de insumos</h3>
                </div>
            ...
            <article class="tabla">
                <table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
                    ...
                    <tbody>
                        <?php
							$obj= new conectarDB();
	                        $data= $obj->subconsulta("CALL suministrosAsigna_Saldo('".$_GET['idpedido']."')");
                            $dat= json_encode($data);
                                if ($dat=='null') {
                                    echo '
                                     <tr>
                            <td colspan="2" style="text-align:right">JJJJJJJJJJJJJJJJJJ:</td>
                                    ...
                                    foreach ($data as $filas) { ?>
                                        <tr>
                                            ...
                                            <td align="right"><?php echo $filas['saldo'] ?></td>
               ...
               <form action="" id="formulario" class="compras" onsubmit="return compra();">
                    ...
                    <div class="comprasA">
                        <label for="" class="">Insumo
                            <select class="form-control" name="insumo" id="insumo" autofocus style="width:500px" required>
                                <option value=""></option>                                   
                                <?php
                                    $obj = new conectarDB();
                                    $data = $obj->consultar("CALL suministros_InvetarioResumen()");
                                    foreach($data as $key){
                                        echo "<option value='".$key['codigo']."'>".$key['insumos']."</option>";
                                    }
                                ?>
                            </select>
                        </label>
                    ...
                    <div class="comprasB">    
                        <label for="" class="">Características</label> 
                        <select class="form-control" title="Ingrese caracteristicas del producto" style="width:500px" id="productos" onchange="producto()"> 
                        </select> 
        ...
        <div>
            ...
            <script src="../aplicaciones/js/suministrosAsignaciones.js"></script>
        </div>
    </body>
