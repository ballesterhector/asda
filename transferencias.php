...
<!--La transferencia dura solo un dia-->
  <body>
    <header>
		...
		<div class="recepcion">
			<div class="titulo">
				<h3 class="titulos" id="">Data transferencias unidades registradas</h3>
			</div>
      ...
      <article class="tabla">
      	<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
			...
			<tbody>
				<?php
					$obj= new conectarDB();
					$data= $obj->subconsulta("CALL transferenciasSelectProceso('0')");
						...
						foreach ($data as $filas) { ?>
							<tr>
								...
								<td class="text-center icono">
									<a href='javascript:unidades(<?php echo $filas['numeroTransfe'] ?>,<?php echo $niveles ?>)' class='glyphicon glyphicon-folder-open' title='Transferir'</a>
								</td>
							</tr>
					<?php } ?>
				<?php } ?>
								...
								<article class="">
									<div class="subladotop">
										...
										<label for="" class="">Tipo
										    <input type="text" class="form-control" name="tipo" id="tipo" value="transferenciasunidades" readonly>
										</label>
									</div>
									<div class="llegada">
    ...
    <div>
		...
		<script src="aplicaciones/js/transferencias.js"></script>
	</div>
  </body>
</html>