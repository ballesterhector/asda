...
$('#cliBusca').on('change', function () {
    ...
    document.location = 'inventarioTeoricoLote.php?id_cliente=' + numClie;
});

function inventarioExcel() {
    var dat_Clien = idclie;
    document.location.href = ("inventarioTeoricoLoteExcel.php?id_cliente=" + dat_Clien);
}

function inventariopdf() {
    var data_Clien = idclie;
    window.open('inventarioTeoricoLoteHtml.php?id_cliente=' + data_Clien, 'reporte');
}
