...
function inventarioExcel() {
    ...
    document.location.href = ("inventarioDisponibleEtiquetaExcel.php?id_cliente=" + dat_Clien);
}

function inventariopdf() {
    var data_Clien = idclie;
    window.open('inventarioDisponibleEtiquetaPdf.php?id_cliente=' + data_Clien, 'reporte');
}
