...
if ( !function_exists("mb_strlen") ) {
  ...
  function mb_convert_encoding($data, $to_encoding, $from_encoding = 'utf-8-8') {
    if (str_replace('-', '', strtolower($to_encoding)) === 'utf-8-8') {
      return utf-8-8_encode($data);
    } else {
      return utf-8-8_decode($data);
    }
  }
  ...
  function mb_strlen($str, $encoding = 'iso-8859-1') {
    switch (str_replace('-', '', strtolower($encoding))) {
      case "utf-8-8": return strlen(utf-8-8_encode($str));
      case "8bit": return strlen($str);
      default:     return strlen(utf-8-8_decode($str));
    }
  }
