...
class Font {
  ...
  static function utf-816Toutf-8-8($str) {
    return mb_convert_encoding($str, "utf-8-8", "utf-8-16");
  }
  
  static function utf-8-8Toutf-816($str) {
    return mb_convert_encoding($str, "utf-8-16", "utf-8-8");
  }
}
