...
?>
    ...
    <body>
        <header>
            ...
            <div class="recepcion">
                <div class="titulo">
                    <h4 class="titulos">Actualizar ubicación de las etiquetas</h4>
                </div>
                <div class="ayuda">
                ...
                <div class="fechas">
                    ...
                    <div class="">
                    	<select class="form-control" name="ubica" id="ubica" style="width:120px;" required="require">
                    		<option>Seco</option>
                    		<option>Frio</option>
                    		<option>La chapa</option>
                    		<option>Jaula</option>
                    	</select>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#ejecuta').on('click', function () {
                ...
                if(numClie>0){
                    document.location = 'modificarUbicacion.php?clibus=' + numClie + '&del='+ dels + '&al=' + als;
                }else{
            ...
            $('#modifica').on('click',function(){
                ...
                var ubic = document.getElementById('ubica').value;
                var user = document.getElementById('modificador').value;
                $('#modifica').hide();
                $.ajax({
                    type: 'GET',
                    url: url,
                    data: 'proceso=' + 'modifica' + '&clie=' + clien + '&del=' + del + '&al=' + al + '&ubic=' + ubic + '&usua=' + user,
